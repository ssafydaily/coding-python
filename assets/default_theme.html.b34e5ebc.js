import{_ as e,r as s,o,c as i,a as n,b as l,d as a,e as p}from"./app.00a4d25c.js";const u={},r=p(`<h1 id="default-theme" tabindex="-1"><a class="header-anchor" href="#default-theme" aria-hidden="true">#</a> Default Theme</h1><h2 id="config" tabindex="-1"><a class="header-anchor" href="#config" aria-hidden="true">#</a> Config</h2><blockquote><p><strong>navbar</strong></p><ul><li><p>타입: <code>false | (NavbarItem | NavbarGroup | strirg)[]</code></p></li><li><p>기본값: <code>[]</code></p></li><li><p><code>false</code>: navbar 사용안함</p></li></ul></blockquote><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
